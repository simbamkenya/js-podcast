    ...
    <header className="h-48 py-12 bg-cover bg-bottom bg-blend-screen bg-fixed bg-no-repeat" style={{backgroundImage: "url(" + "https://images.unsplash.com/photo-1485579149621-3123dd979885?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1031&q=80" + ")"}}>
       <div className="container mx-auto flex items-center justify-between">
            ...
            <nav className="ml-12">
              <ul className="flex">
                <li className="mr-2">
                    <a href="#" className="text-white text-base font-semibold no-underline">Podcasts</a>
                </li>
                <li className="mr-2">
                    <a href="#" className="text-white text-base font-semibold no-underline">Coaching</a>
                </li>
                <li className="mr-2">
                    <a href="#" className="text-white text-base font-semibold no-underline">Meetups</a>
                </li>
                <li className="mr-2">
                    <a href="#" className="text-white text-base font-semibold no-underline">Login/sign Up</a>
                </li>
              </ul>
            </nav>
       </div>
