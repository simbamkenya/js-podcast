...
function Episode({ episode, url }) {
  ...
  return (
    <div className="rounded-md max-w-4xl drop-shadow-md bg-white my-8 mx-4">
      <div
      ...
      <div className="">
        <div className="px-8 py-4">
          <div className="flex items-center pb-2">
            ...
            <span className="ml-6 text-sm">Jan 03, 2023</span>
          </div>

          <h1 className="text-lg font-semibold tracking-tight">{episode.title} </h1>
          <p className="text-base leading-6">{episode.description}</p>
